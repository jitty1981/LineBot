...
$json = file_get_contents('https://api.mlab.com/api/1/databases/dippy/collections/linebot?apiKey='.$api_key.'&q={"$or":[{"question":{"$regex":"จิตติ*","$options":"i"}},{"answer":{"$regex":"จิตติ*","$options":"i"}}]}');
